...
class RpicController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $rpic = Rpic::create([
            ...
            'date_of_certified'     => $request->input('date_of_certified'),
            'certificate_exp'       => date('Y-m-d H:i:s', strtotime('+2 years', strtotime($request->input('date_of_certified')))),
    ...
    public function update(Request $request, $id)
    {
        ...
        */
        ...
        $rpic->date_of_certified        = $request->input('date_of_certified');
        $rpic->certificate_exp          = date('Y-m-d H:i:s', strtotime('+2 years', strtotime($request->input('date_of_certified'))));
