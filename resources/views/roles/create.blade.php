                    ...
                    <div class="col-span-12">
                            <div class="card mb-4">
                                <div class="card-header">
                                    <div class="card-title py-3">Create New Role</div>
                                ...
                                <div class="row">
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                        <div class="form-group">
                                            <strong>Name:</strong>
                                            {!! Form::text('name', null, array('placeholder' => 'Enter Role Name Here','class' => 'form-control')) !!}
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                        <div class="form-group">
                                    ...
                                    <div class="col-span-12">
                                            ...
                                            <a class="btn btn-danger float-right" href="{{url('/roles')}}">Cancel</a>
                                        </div>
                                </div>
                                {!! Form::close() !!}
                                </div>
