<?php 
echo "<h2>BAO EXPIRY Notification</h2>";
...
$DateTovalidatewith->modify("last day of previous month");
...
if (count($arr)>0) {
 ...
 foreach ($arr as $value) {
   ...
   //echo "$arrallexpiredauditors[auditor_s_name] ~".$validity;
   echo " <br/><br/><br/><br/>$auditorfirstname ".$arrallexpiredauditors['email'];
   //echo "</br>";
...
$mailContent = "Dear ".$auditorfirstname.",<br/><br/>
                I am contacting you today to remind you that your IS-BAO accreditation has expired on <b>".$validity."</b>.<br/><br/> If you intend to renew your accreditation, these are the steps you will need to follow:
                <br/>
                <ul style='list-style-type: disc;' style='margin-left:2%;'>
                <li>Apply online, providing an updated resume and some information related to your recent audit experience. You can find the online form <a href='https://tools.ibac.org/is-bao/auditor-application-renewal/$id' target='_blank'>here</a>.
                </li>
	...
	//Testing
	   ...
	   //sendemailtouser("xmantralastrock@gmail.com",$auditorfirstname,$validity);
